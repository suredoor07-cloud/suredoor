...
import { settingsService, messagesService } from '@/lib/supabase'
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-8 pt-8 border-t">
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 bg-gray-100 hover:bg-primary-600 hover:text-white rounded-full flex items-center justify-center transition-colors">
              ...
              <div className="bg-gray-50 rounded-3xl p-8 md:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 disabled:bg-primary-400 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 w-full md:w-auto"
                  >
                    {isSubmitting ? (
                      <>
      ...
      <section className="h-96 bg-gray-200">
        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-100 to-primary-200">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">Lagos State, Nigeria</p>
          </div>
        </div>
      </section>
    </>
